...
namespace engine
{
	...
	struct game_object_properties final
	{
		...
		float friction = 0.9f;
		float RollingGroundFriction = 0.f;
    ...
    public:
		...
		float	  RollingGroundFriction() const { return m_RollingGroundFriction; }
    ...
    private:
		...
		// object's ground rolling friction
		float			m_RollingGroundFriction{ 0.f };
